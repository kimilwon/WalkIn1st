...
{    
    ...
    public static class PCANBasic
    {
        ...
        /// <summary>
        ///PCAN-채널 핸들을 연결할 수 있음(플러그 앤 플레이 하드웨어: 하드웨어가 플러그 인됨을 의미함)
        /// </summary>
        public const int PCAN_CHANNEL_AVAILABLE = 1;
        /// <summary>
        ///PCAN-채널 핸들이 유효하며, 이미 사용 중임
        /// </summary>
        public const int PCAN_CHANNEL_OCCUPIED = 2;
        /// <summary>
        /// PCAN-Channel 핸들은 이미 PCAN-View 애플리케이션에서 사용 중이지만 연결할 수 있음
        /// </summary>
